ALTER TABLE "sneakers" ADD COLUMN "catalog_url" text;--> statement-breakpoint
ALTER TABLE "sneakers" ADD COLUMN "nickname" text;--> statement-breakpoint
ALTER TABLE "sneakers" drop column "search_vector";--> statement-breakpoint
